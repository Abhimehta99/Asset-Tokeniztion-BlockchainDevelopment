  ...
  render() {
    ...
    return (
      <div className="container">
        <h1>Burger Token for BurgerKing</h1>
        <h2>Enable your account</h2>
        <h3>Address to allow:</h3> <input type="text" name="kycAddress" value={this.state.kycAddress} onChange={this.handleInputChange} /><br/>
        <button type="button" onClick={this.handleKycSubmit}>Add Address to Whitelist</button>
        <h2>Buy Burger-Tokens</h2>
        <p>Send Ether to this address: {this.state.tokenSaleAddress}</p>
        <p>You have: {this.state.userTokens} Burger Tokens</p>
